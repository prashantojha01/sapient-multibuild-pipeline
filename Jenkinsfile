pipeline {
    ...
    stages {
        ...
        stage('sonar scanner') {
            steps {
                    sh 'mvn clean verify sonar:sonar  -Dsonar.projectKey=chatappojha  -Dsonar.host.url=http://20.25.39.13:9000  -Dsonar.login=sqp_52b730d5bd175a42658c314bf225bb8d6fef6d84'
            }
        }
